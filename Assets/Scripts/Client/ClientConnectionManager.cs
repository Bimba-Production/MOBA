...
namespace TMG.NFE_Tutorial
{
    public class ClientConnectionManager : MonoBehaviour
    {
        ...
        {
            var setverWorld = ClientServerBootstrap.CreateServerWorld("Bobok Server World");

            var serverEndpoint = NetworkEndpoint.AnyIpv4.WithPort(Port);
            {
                using var networkDriverQuery = setverWorld.EntityManager.CreateEntityQuery(ComponentType.ReadWrite<NetworkStreamDriver>());
        ...
        {
            var clientWorld = ClientServerBootstrap.CreateClientWorld("Bobok Client World");
